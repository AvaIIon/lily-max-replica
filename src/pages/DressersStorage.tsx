  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4">
        <PromotionalBanner currentCategory="Dressers & Storage" />
      </div>
        ...
        {loading ? (
          ...
          <>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              ...
              return (
                <Card key={productHandle} className="group hover:shadow-2xl hover:shadow-pink-500/20 transition-all duration-300 border-2 hover:border-pink-300 bg-gradient-to-br from-white to-pink-50">
